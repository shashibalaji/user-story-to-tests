...
export class GroqClient {
  ...
  constructor() {
    ...
    async generateFeatureFile(systemPrompt: string, userPrompt: string): Promise<GroqResponse> {
      ...
      console.log('🚀 Making Groq API call for feature file:');
      ...
      try {
        ...
        console.error('❌ Error calling Groq API (feature file):', error);
        throw error;
      }
    }
    ...
    async generateTests(systemPrompt: string, userPrompt: string): Promise<GroqResponse> {
      ...
      console.log('🚀 Making Groq API call for test case generation:');
      console.log(`📍 Endpoint: ${endpoint}`);
      console.log(`🤖 Model: ${this.model}`);
      console.log(`🔑 API Key: ${this.apiKey.substring(0, 10)}...${this.apiKey.substring(this.apiKey.length - 4)}`);
      console.log(`📝 Request body:`, JSON.stringify(requestBody, null, 2));
      ...
      try {
        ...
        console.error('❌ Error calling Groq API (test case generation):', error);
        throw error;
      }
    }
